# Generated by Powerlevel10k configuration wizard on 2020-01-20 at 10:46 CST.
...
# no frame, dark, sparse, few icons, concise, transient_prompt, instant_prompt=verbose.
...
() {
  ...
  # Show virtualenv's prompt instead of dir name
